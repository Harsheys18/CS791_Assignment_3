...
python3 d3pm_cond.py --mode sample --num_samples 16 --num_steps 500 --mask_type linear | tee -a log_cond.txt
...
python3 d3pm_cond.py --mode sample --num_samples 16 --num_steps 1000 --mask_type linear | tee -a log_cond.txt   
...
python3 d3pm_cond.py --mode sample --num_samples 16 --num_steps 1500 --mask_type linear | tee -a log_cond.txt
...
python3 d3pm_cond.py --mode sample --num_samples 16 --num_steps 1500 --mask_type uniform | tee -a log_cond.txt
...
python3 d3pm_cond.py --mode sample --num_samples 16 --num_steps 1500 --mask_type cosine | tee -a log_cond.txt
...
python3 d3pm_cond.py --mode sample --num_samples 16 --num_steps 1500 --mask_type quadratic | tee -a log_cond.txt
...
python3 d3pm_cond.py --mode sample --num_samples 16 --num_steps 1500 --mask_type exponential | tee -a log_cond.txt
